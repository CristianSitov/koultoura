                ...
                <div class="py-8 lg:py-8 pt-0 px-4 mx-auto max-w-screen-xl">
                        ...
                        <div class="col-span-3 md:gap-5">
                            ...
                            <div class="row grid grid-cols-1 sm:grid-cols-3 md:gap-5">
                                <a href="//centriphery.eu"
                                   target="_blank"
                                   class="flex mx-auto w-2/3 md:w-full items-center p-8 mb-1 text-center bg-gray-50 rounded hover:bg-gray-100">
                    ...
                    <div class="mt-3 space-y-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-4 xl:gap-8 md:space-y-0 mb-12 md:mt-4">
                        <a href="//europanostra.org"
                           target="_blank"
                           class="flex mx-auto w-2/3 md:w-full items-center p-8 text-center bg-gray-50 rounded hover:bg-gray-100">
                    ...
                    <div class="mt-3 space-y-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-4 xl:gap-8 md:space-y-0 mb-12 md:mt-4">
                        <a href="//patrimoniu.ro"
                           target="_blank"
                           class="flex mx-auto w-2/3 md:w-full items-center md:p-8 text-center bg-gray-50 rounded hover:bg-gray-100">
