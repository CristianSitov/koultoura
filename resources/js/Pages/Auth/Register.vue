...
const submit = () => {
    form.post(route('2024.event-registration'), {
    ...
    <AppLayout title="Register">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <JetAuthenticationCard width="large" class="shadow-xl sm:rounded-lg">
                    <div class="text-center my-8">
                        <span class="text-3xl text-black font-sans font-bold uppercase"><Link :href="route('2024.home')">why culture matters</Link></span><br />
                        <span class="text-xl text-black font-sans font-bold">{{ $t('International Symposium') }}</span><br />
                        <span class="text-xl text-black font-sans font-bold">{{ $t('17-18-19 October 2024') }}</span>
                    </div>
                                                    ...
                                                    <div class="flex items-start"
                                                        ...
                                                        <div class="ml-3 text-sm">
                                                            <label :for="'event_details_day_'+idx.id.toString()"
                                                                ...
                                                                <strong v-if="idx.id.toString() === '3'"
                                                                    ...
                                                                    <span
                                                                        v-html="$t('Registration for the workshops')"></span>, <Link
                                                                    class="underline text-red-600"
                                                                :href="route('2024.home')+'/#'+($page.props.locale === 'en' ? 'workshops' : 'ateliere')"
                                                                @click="handleMenuClick(item)">{{ $t('HERE') }}</Link>.</strong></label>
                                                            <div class="mt-3 mb-5">
                                                        <span class="block">
                                                        ...
                                                        <span class="block">
                                                            <span class="text-sm inline-flex align-middle leading-6"><LocationMarkerIcon
                                                                class="h-5 md:h-6 sm:h-4 w-5 md:w-7 sm:w-5 mr-3"
                                                                aria-hidden="true"
                                                            />{{ $t('schedule short '+idx.id+' location') }}</span>
                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
