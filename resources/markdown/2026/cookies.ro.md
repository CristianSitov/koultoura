...
Această politică se referă la cookie-urile și paginile web operate de Asociația PRIN BANAT cu sediul social în Timișoara, jud. Timiș, România, inclusiv site-ul simpozionului Why Culture Matters.
...
# 5.1 Ce cookie-uri folosim pe whyculturematters.eu
Pe acest site folosim un număr mic de cookie-uri, toate necesare funcționării lui:

* `why_culture_matters_consent` — reține alegerea ta privind cookie-urile, ca să nu îți fie cerută la fiecare vizită (12 luni).
* Cookie-ul de sesiune al site-ului — ține minte formularul de înscriere între pagini, cât timp browserul este deschis.
